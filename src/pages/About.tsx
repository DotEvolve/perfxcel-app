    ...
    <div className="pb-20">
      ...
      <section className="bg-secondary-900 text-white py-20 px-4 sm:px-6 lg:px-8 mb-16 rounded-b-[3rem] shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-secondary-300">
            ...
            accredited training programs designed for the modern business
            landscape.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32">
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="text-primary-600 font-bold tracking-widest uppercase mb-2">
              Our Story
            </div>
            <h2 className="text-4xl font-extrabold text-secondary-900 mb-6">
              A Legacy of Excellence in Corporate Education
            </h2>
            <div className="space-y-4 text-lg text-secondary-700">
              <p>
                Founded in 2008, PerfXcel began with a simple mission: to bridge
                the gap between academic theory and practical corporate
                execution. What started as a small consultancy in Riyadh has
                grown into a premier professional development institute serving
                the entire EMEA region.
              </p>
              <p>
                Over the past decade, we have partnered with thousands of
                organisations to upskill their workforce, delivering highly
                specialised training programs that drive tangible business
                results and individual career growth.
              </p>
              <p>
                Today, we offer over 1,200 meticulously designed courses
                spanning finance, leadership, IT, HR, and engineering, all
                accredited by the world's most prestigious professional bodies.
              </p>
            </div>
          </div>
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="rounded-3xl p-10 bg-secondary-900 text-white relative overflow-hidden shadow-xl">
            ...
            <p className="text-lg text-secondary-300 relative z-10">
              To empower professionals and organisations by delivering
              practical, industry-leading education that drives measurable
              performance improvements and career advancement.
            </p>
          </div>
          <div className="rounded-3xl p-10 bg-primary-600 text-white relative overflow-hidden shadow-xl">
            ...
            <p className="text-lg text-primary-100 relative z-10">
              To be the globally recognised standard of excellence in corporate
              training, shaping the future of continuous professional
        ...
        <section className="bg-secondary-50 py-16 text-center overflow-hidden">
          <h2 className="text-2xl font-bold text-secondary-900 mb-12">
          ...
          <div className="relative w-full overflow-hidden">
            ...
            <div className="animate-marquee hover:pause flex items-center">
              ...
              {[1, 2].map((set) => (
                <div
                  key={set}
                  className="flex gap-12 px-6 items-center shrink-0"
                >
                  {/* PMI */}
                  ...
                  <div className="bg-white px-8 py-4 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center w-48 h-20 shrink-0">
                    <svg
                      viewBox="0 0 110 40"
                      className="h-10 w-full max-w-[110px]"
                    >
                      <rect
                        x="0"
                        y="0"
                  ...
                  <div className="bg-white px-8 py-4 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center w-48 h-20 shrink-0">
                    <svg
                      viewBox="0 0 130 40"
                      className="h-10 w-full max-w-[130px]"
                    >
                      <circle
                        cx="20"
                        cy="20"
        ...
        <section className="bg-gradient-to-r from-secondary-900 to-secondary-800 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <Link
            to="/courses"
            className="inline-flex relative z-10 bg-primary-600 hover:bg-primary-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg transition-colors"
          >
