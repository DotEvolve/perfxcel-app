      ...
      <aside className="w-full md:w-64 shrink-0 space-y-6">
        <div className="glass-panel p-6 rounded-2xl shadow-sm">
          <h3 className="text-lg font-semibold mb-4 flex items-center">
            <Search className="w-5 h-5 mr-2 text-primary-500" /> Filter Catalog
          </h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none transition-shadow"
              >
      ...
      <div className="flex-1">
        <div className="mb-8">
          ...
          <p className="text-lg text-secondary-600 mt-2">
            Discover our premium selection of professional courses.
          </p>
        </div>
  ...
  return (
    ...
    >
      <div className="flex-1">
        ...
        <p className="text-secondary-600 line-clamp-2 text-sm">
          {course.description}
        </p>
      </div>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="glass-panel rounded-3xl p-8 md:p-12 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-secondary-900 mb-6 leading-tight">
            {course.title}
          </h1>
